var World = ["Rome", "Dubai", "Newyork", "London", "Tokyo"];
console.log(World);
var WorldSorted = World.concat().sort(); // concat creates a new copy without mutating original. Sort sorts it in alphabetical order.
